...
__all__ = [
    "OrgResponse",
    "Organizations",
    "OrganizationsAlternateContact",
    "OrganizationsInfinityManagerSettings",
    "OrganizationsOrgOwner",
    "OrganizationsProductEnablement",
    "OrganizationsProductEnablementPoDetail",
    "OrganizationsProductSubscription",
    "OrganizationsRepoScanSettings",
    "OrganizationsUsersInfo",
    "RequestStatus",
]


class OrganizationsAlternateContact(BaseModel):
...
class OrganizationsInfinityManagerSettings(BaseModel):
...
class OrganizationsOrgOwner(BaseModel):
    email: str
...
class OrganizationsProductEnablementPoDetail(BaseModel):
...
class OrganizationsProductEnablement(BaseModel):
    ...
    po_details: Optional[List[OrganizationsProductEnablementPoDetail]] = FieldInfo(alias="poDetails", default=None)


class OrganizationsProductSubscription(BaseModel):
    product_name: str = FieldInfo(alias="productName")
...
class OrganizationsRepoScanSettings(BaseModel):
...
class OrganizationsUsersInfo(BaseModel):
...
class Organizations(BaseModel):
    ...
    alternate_contact: Optional[OrganizationsAlternateContact] = FieldInfo(alias="alternateContact", default=None)
    ...
    infinity_manager_settings: Optional[OrganizationsInfinityManagerSettings] = FieldInfo(
    ...
    org_owner: Optional[OrganizationsOrgOwner] = FieldInfo(alias="orgOwner", default=None)
    """Org owner."""

    org_owners: Optional[List[OrganizationsOrgOwner]] = FieldInfo(alias="orgOwners", default=None)
    """Org owners"""
    ...
    product_enablements: Optional[List[OrganizationsProductEnablement]] = FieldInfo(
        alias="productEnablements", default=None
    )

    product_subscriptions: Optional[List[OrganizationsProductSubscription]] = FieldInfo(
        alias="productSubscriptions", default=None
    )

    repo_scan_settings: Optional[OrganizationsRepoScanSettings] = FieldInfo(alias="repoScanSettings", default=None)
    """Repo scan setting definition"""

    type: Optional[Literal["UNKNOWN", "CLOUD", "ENTERPRISE", "INDIVIDUAL"]] = None

    users_info: Optional[OrganizationsUsersInfo] = FieldInfo(alias="usersInfo", default=None)
    """Users information."""
