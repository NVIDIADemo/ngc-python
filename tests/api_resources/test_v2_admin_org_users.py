...
class TestV2AdminOrgUsers:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_add_role(self, client: Ngc) -> None:
        v2_admin_org_user = client.v2_admin_org_users.add_role(
            id="id",
            org_name="org-name",
        )
        assert_matches_type(User, v2_admin_org_user, path=["response"])
    ...
    def test_raw_response_add_role(self, client: Ngc) -> None:
        response = client.v2_admin_org_users.with_raw_response.add_role(
            id="id",
            org_name="org-name",
        )
        ...
        v2_admin_org_user = response.parse()
        assert_matches_type(User, v2_admin_org_user, path=["response"])

    @parametrize
    def test_streaming_response_add_role(self, client: Ngc) -> None:
        with client.v2_admin_org_users.with_streaming_response.add_role(
            id="id",
            org_name="org-name",
        ) as response:
    ...
    def test_path_params_add_role(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.v2_admin_org_users.with_raw_response.add_role(
                id="id",
                org_name="",
            )
...
class TestAsyncV2AdminOrgUsers:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_add_role(self, async_client: AsyncNgc) -> None:
        v2_admin_org_user = await async_client.v2_admin_org_users.add_role(
            id="id",
            org_name="org-name",
        )
        assert_matches_type(User, v2_admin_org_user, path=["response"])
    ...
    async def test_raw_response_add_role(self, async_client: AsyncNgc) -> None:
        response = await async_client.v2_admin_org_users.with_raw_response.add_role(
            id="id",
            org_name="org-name",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        v2_admin_org_user = await response.parse()
        assert_matches_type(User, v2_admin_org_user, path=["response"])

    @parametrize
    async def test_streaming_response_add_role(self, async_client: AsyncNgc) -> None:
        async with async_client.v2_admin_org_users.with_streaming_response.add_role(
            id="id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_add_role(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.v2_admin_org_users.with_raw_response.add_role(
                id="id",
                org_name="",
            )
