...
class TestUsers:
    ...
    def test_method_create(self, client: Ngc) -> None:
        user = client.super_admin_user.orgs.teams.users.create(
            team_name="team-name",
            org_name="org-name",
            email="xxxxxx",
        )
    ...
    def test_raw_response_create(self, client: Ngc) -> None:
        response = client.super_admin_user.orgs.teams.users.with_raw_response.create(
            team_name="team-name",
            org_name="org-name",
            email="xxxxxx",
        )
    ...
    def test_streaming_response_create(self, client: Ngc) -> None:
        with client.super_admin_user.orgs.teams.users.with_streaming_response.create(
            team_name="team-name",
            org_name="org-name",
            email="xxxxxx",
        ) as response:
    ...
    def test_path_params_create(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.super_admin_user.orgs.teams.users.with_raw_response.create(
                team_name="team-name",
                org_name="",
                email="xxxxxx",
            )
    ...
    def test_method_add(self, client: Ngc) -> None:
        user = client.super_admin_user.orgs.teams.users.add(
            id="id",
            org_name="org-name",
            team_name="team-name",
        )
    ...
    def test_raw_response_add(self, client: Ngc) -> None:
        response = client.super_admin_user.orgs.teams.users.with_raw_response.add(
            id="id",
            org_name="org-name",
            team_name="team-name",
        )
    ...
    def test_streaming_response_add(self, client: Ngc) -> None:
        with client.super_admin_user.orgs.teams.users.with_streaming_response.add(
            id="id",
            org_name="org-name",
            team_name="team-name",
        ) as response:
    ...
    def test_path_params_add(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.super_admin_user.orgs.teams.users.with_raw_response.add(
                id="id",
                org_name="",
                team_name="team-name",
            )
...
class TestAsyncUsers:
    ...
    async def test_method_create(self, async_client: AsyncNgc) -> None:
        user = await async_client.super_admin_user.orgs.teams.users.create(
            team_name="team-name",
            org_name="org-name",
            email="xxxxxx",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncNgc) -> None:
        response = await async_client.super_admin_user.orgs.teams.users.with_raw_response.create(
            team_name="team-name",
            org_name="org-name",
            email="xxxxxx",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncNgc) -> None:
        async with async_client.super_admin_user.orgs.teams.users.with_streaming_response.create(
            team_name="team-name",
            org_name="org-name",
            email="xxxxxx",
        ) as response:
    ...
    async def test_path_params_create(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.super_admin_user.orgs.teams.users.with_raw_response.create(
                team_name="team-name",
                org_name="",
                email="xxxxxx",
            )
    ...
    async def test_method_add(self, async_client: AsyncNgc) -> None:
        user = await async_client.super_admin_user.orgs.teams.users.add(
            id="id",
            org_name="org-name",
            team_name="team-name",
        )
    ...
    async def test_raw_response_add(self, async_client: AsyncNgc) -> None:
        response = await async_client.super_admin_user.orgs.teams.users.with_raw_response.add(
            id="id",
            org_name="org-name",
            team_name="team-name",
        )
    ...
    async def test_streaming_response_add(self, async_client: AsyncNgc) -> None:
        async with async_client.super_admin_user.orgs.teams.users.with_streaming_response.add(
            id="id",
            org_name="org-name",
            team_name="team-name",
        ) as response:
    ...
    async def test_path_params_add(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.super_admin_user.orgs.teams.users.with_raw_response.add(
                id="id",
                org_name="",
                team_name="team-name",
            )
