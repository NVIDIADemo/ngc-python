...
class TestUsers:
    ...
    def test_method_crm_sync(self, client: Ngc) -> None:
        user = client.admin.users.crm_sync(
            0,
        )
        assert_matches_type(UserCRMSyncResponse, user, path=["response"])

    @parametrize
    def test_raw_response_crm_sync(self, client: Ngc) -> None:
        response = client.admin.users.with_raw_response.crm_sync(
            0,
        )
    ...
    def test_streaming_response_crm_sync(self, client: Ngc) -> None:
        with client.admin.users.with_streaming_response.crm_sync(
            0,
        ) as response:
    ...
    def test_method_migrate_deprecated_roles(self, client: Ngc) -> None:
        user = client.admin.users.migrate_deprecated_roles(
            "id",
        )
    ...
    def test_raw_response_migrate_deprecated_roles(self, client: Ngc) -> None:
        response = client.admin.users.with_raw_response.migrate_deprecated_roles(
            "id",
        )
    ...
    def test_streaming_response_migrate_deprecated_roles(self, client: Ngc) -> None:
        with client.admin.users.with_streaming_response.migrate_deprecated_roles(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_migrate_deprecated_roles(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.admin.users.with_raw_response.migrate_deprecated_roles(
                "",
            )
...
class TestAsyncUsers:
    ...
    async def test_method_crm_sync(self, async_client: AsyncNgc) -> None:
        user = await async_client.admin.users.crm_sync(
            0,
        )
        assert_matches_type(UserCRMSyncResponse, user, path=["response"])
    ...
    async def test_raw_response_crm_sync(self, async_client: AsyncNgc) -> None:
        response = await async_client.admin.users.with_raw_response.crm_sync(
            0,
        )
    ...
    async def test_streaming_response_crm_sync(self, async_client: AsyncNgc) -> None:
        async with async_client.admin.users.with_streaming_response.crm_sync(
            0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_migrate_deprecated_roles(self, async_client: AsyncNgc) -> None:
        user = await async_client.admin.users.migrate_deprecated_roles(
            "id",
        )
        assert_matches_type(User, user, path=["response"])
    ...
    async def test_raw_response_migrate_deprecated_roles(self, async_client: AsyncNgc) -> None:
        response = await async_client.admin.users.with_raw_response.migrate_deprecated_roles(
            "id",
        )
    ...
    async def test_streaming_response_migrate_deprecated_roles(self, async_client: AsyncNgc) -> None:
        async with async_client.admin.users.with_streaming_response.migrate_deprecated_roles(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_migrate_deprecated_roles(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.admin.users.with_raw_response.migrate_deprecated_roles(
                "",
            )
