...
from ngc.types.admin.orgs import (
    UserRemoveResponse,
)
...
class TestUsers:
    ...
    def test_method_create(self, client: Ngc) -> None:
        user = client.admin.orgs.users.create(
            org_name="org-name",
            email="xxxxxx",
        )
    ...
    def test_raw_response_create(self, client: Ngc) -> None:
        response = client.admin.orgs.users.with_raw_response.create(
            org_name="org-name",
            email="xxxxxx",
        )
    ...
    def test_streaming_response_create(self, client: Ngc) -> None:
        with client.admin.orgs.users.with_streaming_response.create(
            org_name="org-name",
            email="xxxxxx",
        ) as response:
    ...
    def test_path_params_create(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.admin.orgs.users.with_raw_response.create(
                org_name="",
                email="xxxxxx",
            )
    ...
    def test_method_retrieve(self, client: Ngc) -> None:
        user = client.admin.orgs.users.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Ngc) -> None:
        response = client.admin.orgs.users.with_raw_response.retrieve(
            user_email_or_id="user-email-or-id",
            org_name="org-name",
        )
    ...
    def test_streaming_response_retrieve(self, client: Ngc) -> None:
        with client.admin.orgs.users.with_streaming_response.retrieve(
            user_email_or_id="user-email-or-id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.admin.orgs.users.with_raw_response.retrieve(
                user_email_or_id="user-email-or-id",
                org_name="",
            )
    ...
    def test_method_add(self, client: Ngc) -> None:
        user = client.admin.orgs.users.add(
            id="id",
            org_name="org-name",
        )
        assert_matches_type(User, user, path=["response"])
    ...
    def test_raw_response_add(self, client: Ngc) -> None:
        response = client.admin.orgs.users.with_raw_response.add(
            id="id",
            org_name="org-name",
        )
    ...
    def test_streaming_response_add(self, client: Ngc) -> None:
        with client.admin.orgs.users.with_streaming_response.add(
            id="id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_add(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.admin.orgs.users.with_raw_response.add(
                id="id",
                org_name="",
            )
    ...
    def test_method_add_role(self, client: Ngc) -> None:
        user = client.admin.orgs.users.add_role(
            id="id",
            org_name="org-name",
        )
        assert_matches_type(User, user, path=["response"])
    ...
    def test_raw_response_add_role(self, client: Ngc) -> None:
        response = client.admin.orgs.users.with_raw_response.add_role(
            id="id",
            org_name="org-name",
        )
    ...
    def test_streaming_response_add_role(self, client: Ngc) -> None:
        with client.admin.orgs.users.with_streaming_response.add_role(
            id="id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_add_role(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.admin.orgs.users.with_raw_response.add_role(
                id="id",
                org_name="",
            )
    ...
    def test_method_get_entitlements(self, client: Ngc, respx_mock: MockRouter) -> None:
        respx_mock.get("/v2/admin/org/org-name/entitlements").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        user = client.admin.orgs.users.get_entitlements(
            org_name="org-name",
        )
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_method_get_entitlements_with_all_params(self, client: Ngc, respx_mock: MockRouter) -> None:
        respx_mock.get("/v2/admin/org/org-name/entitlements").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        user = client.admin.orgs.users.get_entitlements(
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_get_entitlements(self, client: Ngc, respx_mock: MockRouter) -> None:
        respx_mock.get("/v2/admin/org/org-name/entitlements").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )

        user = client.admin.orgs.users.with_raw_response.get_entitlements(
            org_name="org-name",
        )
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_streaming_response_get_entitlements(self, client: Ngc, respx_mock: MockRouter) -> None:
        respx_mock.get("/v2/admin/org/org-name/entitlements").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        with client.admin.orgs.users.with_streaming_response.get_entitlements(
            org_name="org-name",
        ) as user:
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_path_params_get_entitlements(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.admin.orgs.users.with_raw_response.get_entitlements(
                org_name="",
            )

    @parametrize
    def test_method_remove(self, client: Ngc) -> None:
        user = client.admin.orgs.users.remove(
            id="id",
            org_name="org-name",
        )
    ...
    def test_raw_response_remove(self, client: Ngc) -> None:
        response = client.admin.orgs.users.with_raw_response.remove(
            id="id",
            org_name="org-name",
        )
    ...
    def test_streaming_response_remove(self, client: Ngc) -> None:
        with client.admin.orgs.users.with_streaming_response.remove(
            id="id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_remove(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.admin.orgs.users.with_raw_response.remove(
                id="id",
                org_name="",
            )
...
class TestAsyncUsers:
    ...
    async def test_method_create(self, async_client: AsyncNgc) -> None:
        user = await async_client.admin.orgs.users.create(
            org_name="org-name",
            email="xxxxxx",
        )
        assert_matches_type(User, user, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncNgc) -> None:
        response = await async_client.admin.orgs.users.with_raw_response.create(
            org_name="org-name",
            email="xxxxxx",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncNgc) -> None:
        async with async_client.admin.orgs.users.with_streaming_response.create(
            org_name="org-name",
            email="xxxxxx",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.admin.orgs.users.with_raw_response.create(
                org_name="",
                email="xxxxxx",
            )
    ...
    async def test_method_retrieve(self, async_client: AsyncNgc) -> None:
        user = await async_client.admin.orgs.users.retrieve(
            user_email_or_id="user-email-or-id",
            org_name="org-name",
        )
        assert_matches_type(User, user, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncNgc) -> None:
        response = await async_client.admin.orgs.users.with_raw_response.retrieve(
            user_email_or_id="user-email-or-id",
            org_name="org-name",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncNgc) -> None:
        async with async_client.admin.orgs.users.with_streaming_response.retrieve(
            user_email_or_id="user-email-or-id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.admin.orgs.users.with_raw_response.retrieve(
                user_email_or_id="user-email-or-id",
                org_name="",
            )
    ...
    async def test_method_add(self, async_client: AsyncNgc) -> None:
        user = await async_client.admin.orgs.users.add(
            id="id",
            org_name="org-name",
        )
        assert_matches_type(User, user, path=["response"])
    ...
    async def test_raw_response_add(self, async_client: AsyncNgc) -> None:
        response = await async_client.admin.orgs.users.with_raw_response.add(
            id="id",
            org_name="org-name",
        )
    ...
    async def test_streaming_response_add(self, async_client: AsyncNgc) -> None:
        async with async_client.admin.orgs.users.with_streaming_response.add(
            id="id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_add(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.admin.orgs.users.with_raw_response.add(
                id="id",
                org_name="",
            )
    ...
    async def test_method_add_role(self, async_client: AsyncNgc) -> None:
        user = await async_client.admin.orgs.users.add_role(
            id="id",
            org_name="org-name",
        )
        assert_matches_type(User, user, path=["response"])
    ...
    async def test_raw_response_add_role(self, async_client: AsyncNgc) -> None:
        response = await async_client.admin.orgs.users.with_raw_response.add_role(
            id="id",
            org_name="org-name",
        )
    ...
    async def test_streaming_response_add_role(self, async_client: AsyncNgc) -> None:
        async with async_client.admin.orgs.users.with_streaming_response.add_role(
            id="id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_add_role(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.admin.orgs.users.with_raw_response.add_role(
                id="id",
                org_name="",
            )
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_method_get_entitlements(self, async_client: AsyncNgc, respx_mock: MockRouter) -> None:
        respx_mock.get("/v2/admin/org/org-name/entitlements").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        user = await async_client.admin.orgs.users.get_entitlements(
            org_name="org-name",
        )
        assert user.is_closed
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_method_get_entitlements_with_all_params(
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_get_entitlements(self, async_client: AsyncNgc, respx_mock: MockRouter) -> None:
        respx_mock.get("/v2/admin/org/org-name/entitlements").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )

        user = await async_client.admin.orgs.users.with_raw_response.get_entitlements(
            org_name="org-name",
        )
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_streaming_response_get_entitlements(self, async_client: AsyncNgc, respx_mock: MockRouter) -> None:
        respx_mock.get("/v2/admin/org/org-name/entitlements").mock(
            return_value=httpx.Response(200, json={"foo": "bar"})
        )
        async with async_client.admin.orgs.users.with_streaming_response.get_entitlements(
            org_name="org-name",
        ) as user:
            assert not user.is_closed
            assert user.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_path_params_get_entitlements(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.admin.orgs.users.with_raw_response.get_entitlements(
                org_name="",
            )

    @parametrize
    async def test_method_remove(self, async_client: AsyncNgc) -> None:
        user = await async_client.admin.orgs.users.remove(
            id="id",
            org_name="org-name",
        )
        assert_matches_type(UserRemoveResponse, user, path=["response"])
    ...
    async def test_raw_response_remove(self, async_client: AsyncNgc) -> None:
        response = await async_client.admin.orgs.users.with_raw_response.remove(
            id="id",
            org_name="org-name",
        )
    ...
    async def test_streaming_response_remove(self, async_client: AsyncNgc) -> None:
        async with async_client.admin.orgs.users.with_streaming_response.remove(
            id="id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_remove(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.admin.orgs.users.with_raw_response.remove(
                id="id",
                org_name="",
            )
