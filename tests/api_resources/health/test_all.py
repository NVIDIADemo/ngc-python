...
class TestAll:
    ...
    def test_method_retrieve_all(self, client: Ngc) -> None:
        all = client.health.all.retrieve_all()
        assert_matches_type(Health, all, path=["response"])
    ...
    def test_raw_response_retrieve_all(self, client: Ngc) -> None:
        response = client.health.all.with_raw_response.retrieve_all()
    ...
    def test_streaming_response_retrieve_all(self, client: Ngc) -> None:
        with client.health.all.with_streaming_response.retrieve_all() as response:
...
class TestAsyncAll:
    ...
    async def test_method_retrieve_all(self, async_client: AsyncNgc) -> None:
        all = await async_client.health.all.retrieve_all()
        assert_matches_type(Health, all, path=["response"])
    ...
    async def test_raw_response_retrieve_all(self, async_client: AsyncNgc) -> None:
        response = await async_client.health.all.with_raw_response.retrieve_all()
    ...
    async def test_streaming_response_retrieve_all(self, async_client: AsyncNgc) -> None:
        async with async_client.health.all.with_streaming_response.retrieve_all() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
