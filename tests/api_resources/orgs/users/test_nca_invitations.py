...
class TestNcaInvitations:
    ...
    def test_method_create(self, client: Ngc) -> None:
        nca_invitation = client.orgs.users.nca_invitations.create(
            org_name="org-name",
        )
    ...
    def test_raw_response_create(self, client: Ngc) -> None:
        response = client.orgs.users.nca_invitations.with_raw_response.create(
            org_name="org-name",
        )
    ...
    def test_streaming_response_create(self, client: Ngc) -> None:
        with client.orgs.users.nca_invitations.with_streaming_response.create(
            org_name="org-name",
        ) as response:
    ...
    def test_path_params_create(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.orgs.users.nca_invitations.with_raw_response.create(
                org_name="",
            )
...
class TestAsyncNcaInvitations:
    ...
    async def test_method_create(self, async_client: AsyncNgc) -> None:
        nca_invitation = await async_client.orgs.users.nca_invitations.create(
            org_name="org-name",
        )
        assert_matches_type(User, nca_invitation, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncNgc) -> None:
        response = await async_client.orgs.users.nca_invitations.with_raw_response.create(
            org_name="org-name",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncNgc) -> None:
        async with async_client.orgs.users.nca_invitations.with_streaming_response.create(
            org_name="org-name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.orgs.users.nca_invitations.with_raw_response.create(
                org_name="",
            )
