...
class TestAuditLogs:
    ...
    def test_method_retrieve(self, client: Ngc) -> None:
        audit_log = client.orgs.audit_logs.retrieve(
            log_id="log-id",
            org_name="org-name",
        )
        assert_matches_type(AuditLogsPresignedURL, audit_log, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Ngc) -> None:
        response = client.orgs.audit_logs.with_raw_response.retrieve(
            log_id="log-id",
            org_name="org-name",
        )
    ...
    def test_streaming_response_retrieve(self, client: Ngc) -> None:
        with client.orgs.audit_logs.with_streaming_response.retrieve(
            log_id="log-id",
            org_name="org-name",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.orgs.audit_logs.with_raw_response.retrieve(
                log_id="log-id",
                org_name="",
            )
...
class TestAsyncAuditLogs:
    ...
    async def test_method_retrieve(self, async_client: AsyncNgc) -> None:
        audit_log = await async_client.orgs.audit_logs.retrieve(
            log_id="log-id",
            org_name="org-name",
        )
        assert_matches_type(AuditLogsPresignedURL, audit_log, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncNgc) -> None:
        response = await async_client.orgs.audit_logs.with_raw_response.retrieve(
            log_id="log-id",
            org_name="org-name",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncNgc) -> None:
        async with async_client.orgs.audit_logs.with_streaming_response.retrieve(
            log_id="log-id",
            org_name="org-name",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.orgs.audit_logs.with_raw_response.retrieve(
                log_id="log-id",
                org_name="",
            )
