...
class TestStarfleetIDs:
    ...
    def test_method_retrieve(self, client: Ngc) -> None:
        starfleet_id = client.orgs.teams.starfleet_ids.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Ngc) -> None:
        response = client.orgs.teams.starfleet_ids.with_raw_response.retrieve(
            starfleet_id="starfleet-id",
            org_name="org-name",
            team_name="team-name",
        )
    ...
    def test_streaming_response_retrieve(self, client: Ngc) -> None:
        with client.orgs.teams.starfleet_ids.with_streaming_response.retrieve(
            starfleet_id="starfleet-id",
            org_name="org-name",
            team_name="team-name",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Ngc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            client.orgs.teams.starfleet_ids.with_raw_response.retrieve(
                starfleet_id="starfleet-id",
                org_name="",
                team_name="team-name",
            )
...
class TestAsyncStarfleetIDs:
    ...
    async def test_method_retrieve(self, async_client: AsyncNgc) -> None:
        starfleet_id = await async_client.orgs.teams.starfleet_ids.retrieve(
            starfleet_id="starfleet-id",
            org_name="org-name",
            team_name="team-name",
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncNgc) -> None:
        response = await async_client.orgs.teams.starfleet_ids.with_raw_response.retrieve(
            starfleet_id="starfleet-id",
            org_name="org-name",
            team_name="team-name",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncNgc) -> None:
        async with async_client.orgs.teams.starfleet_ids.with_streaming_response.retrieve(
            starfleet_id="starfleet-id",
            org_name="org-name",
            team_name="team-name",
        ) as response:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncNgc) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_name` but received ''"):
            await async_client.orgs.teams.starfleet_ids.with_raw_response.retrieve(
                starfleet_id="starfleet-id",
                org_name="",
                team_name="team-name",
            )
