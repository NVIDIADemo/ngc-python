...
from ngc import Ngc, AsyncNgc, APIResponseValidationError
from ngc._types import Omit
from ngc._models import BaseModel, FinalRequestOptions
from ngc._constants import RAW_RESPONSE_HEADER
from ngc._exceptions import NgcError, APIStatusError, APITimeoutError, APIResponseValidationError
from ngc._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, make_request_options
...
def _get_open_connections(client: Ngc | AsyncNgc) -> int:
...
class TestNgc:
    client = Ngc(base_url=base_url, auth_token=auth_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(NgcError):
            with update_env(**{"NVCF_AUTH_TOKEN": Omit()}):
                client2 = Ngc(base_url=base_url, auth_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Ngc) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Ngc(base_url="https://example.com/from_init", auth_token=auth_token, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(NGC_BASE_URL="http://localhost:5000/from/env"):
            client = Ngc(auth_token=auth_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Ngc(base_url="http://localhost:5000/custom/path/", auth_token=auth_token, _strict_response_validation=True),
            Ngc(
    ...
    def test_base_url_trailing_slash(self, client: Ngc) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Ngc) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Ngc) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Ngc(base_url=base_url, auth_token=auth_token, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Ngc(base_url=base_url, auth_token=auth_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Ngc(base_url=base_url, auth_token=auth_token, _strict_response_validation=False)
    ...
    @mock.patch("ngc._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v3/orgs").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v3/orgs").mock(return_value=httpx.Response(500))
    ...
    @mock.patch("ngc._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retries_taken(self, client: Ngc, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        respx_mock.post("/v3/orgs").mock(side_effect=retry_handler)
    ...
    @mock.patch("ngc._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_omit_retry_count_header(self, client: Ngc, failures_before_success: int, respx_mock: MockRouter) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.orgs.with_raw_response.create(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        self, client: Ngc, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.orgs.with_raw_response.create(extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncNgc:
    client = AsyncNgc(base_url=base_url, auth_token=auth_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(NgcError):
            with update_env(**{"NVCF_AUTH_TOKEN": Omit()}):
                client2 = AsyncNgc(base_url=base_url, auth_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncNgc) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(NGC_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncNgc(auth_token=auth_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncNgc) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncNgc) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncNgc) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncNgc(base_url=base_url, auth_token=auth_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncNgc(base_url=base_url, auth_token=auth_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self, async_client: AsyncNgc, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        ...
        response = await client.orgs.with_raw_response.create()
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.orgs.with_raw_response.create(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.orgs.with_raw_response.create(extra_headers={"x-stainless-retry-count": "42"})
